...
<!--
 ...
 -->
<div class="wpcu-carousel-nav wpcu-carousel-nav--bottom-middle" style="
  --navArrowColor: #333;
  --navArrowColorHover: #fff;
  --navBgColor: #fff;
  --navBgColorHover: #ff5500;
  --navBorderColor: #e4e4ed;
  --navBorderColorHover: #ff5500;
">
