        ...
        <div id="cmb2-metabox" class="cmb2-metabox cmb-field-list">
            ...
            <div class="cmb-row cmb-type-radio">
                ...
                <div class="cmb-td">
                    <div class="cmb-theme-wrapper">
                        <select id="c_theme" class="c_theme" name="wcpscu[c_theme]">
                            <option value="c_theme1">Theme-1</option>
                            <option value="c_theme2"
                                <?php if(!empty($c_theme) && $c_theme == "c_theme2"){ echo "selected";}?>>Theme-2
                            </option>
                            <option value="c_theme3"
                                <?php if(!empty($c_theme) && $c_theme == "c_theme3"){ echo "selected";}?>>Theme-3
                            </option>
            ...
            <div class="cmb-row cmb-type-radio">
                ...
                <div class="cmb-td">
                    <ul class="cmb2-radio-list cmb2-list cmb2-radio-switch">
                        <li>
                            <input type="radio" class="cmb2-option  cmb2-radio-switch1"  name="wcpscu[display_full_title]"
                                id="wcpscu[display_full_title]1" value="yes"
            ...
            <div class="cmb-row cmb-type-multicheck">
                ...
                <div class="cmb-td">
                    ...
                    <ul>
                        <p style="font-size: 14px; margin: 13px 0 5px 0; font-style: italic;">Following options
                            available in <a
            ...
            <div class="cmb-row cmb-type-radio" id="sale_ribbon_wrapper">
                <div class="cmb-th">
                    <label
                        for="wcpscu_display_sale_ribbon"><?php esc_html_e('Display "Sale" Ribbon', WCPCSU_TEXTDOMAIN); ?></label>
                </div>
                <div class="cmb-td">
                    <ul class="cmb2-radio-list cmb2-list cmb2-radio-switch">
                        <li><input type="radio" class="cmb2-option cmb2-radio-switch1" name="wcpscu[display_sale_ribbon]"
                                id="wcpscu_display_sale_ribbon1" value="yes"
                        ...
                        <li><input type="radio" class="cmb2-option cmb2-radio-switch2" name="wcpscu[display_sale_ribbon]"
                                id="wcpscu_display_sale_ribbon2" value="no"
            ...
            <div class="cmb-row cmb-type-radio" id="feature_ribbon_wrapper">
                <div class="cmb-th">
                    <label
                        for="wcpscu_display_featured_ribbon"><?php esc_html_e('Display "Featured" Ribbon', WCPCSU_TEXTDOMAIN); ?></label>
                </div>
                <div class="cmb-td">
                    <ul class="cmb2-radio-list cmb2-list cmb2-radio-switch">
                        <li><input type="radio" class="cmb2-option cmb2-radio-switch1" name="wcpscu[display_featured_ribbon]"
                                id="wcpscu_display_featured_ribbon1" value="yes"
                        ...
                        <li><input type="radio" class="cmb2-option cmb2-radio-switch2" name="wcpscu[display_featured_ribbon]"
                                id="wcpscu_display_featured_ribbon2" value="no"
            ...
            <div class="cmb-row cmb-type-radio" id="sold_out_ribbon_wrapper">
                <div class="cmb-th">
                    <label
                        for="wcpscu_display_sold_out_ribbon"><?php esc_html_e('Display the "Sold Out" Ribbon', WCPCSU_TEXTDOMAIN); ?></label>
                </div>
                <div class="cmb-td">
                    <ul class="cmb2-radio-list cmb2-list cmb2-radio-switch">
                        <li><input type="radio" class="cmb2-option cmb2-radio-switch1" name="wcpscu[display_sold_out_ribbon]"
                                id="wcpscu_display_sold_out_ribbon1" value="yes"
                        ...
                        <li><input type="radio" class="cmb2-option cmb2-radio-switch2" name="wcpscu[display_sold_out_ribbon]"
                                id="wcpscu_display_sold_out_ribbon2" value="no"
            ...
            <div class="cmb-row cmb-type-radio">
                ...
                <div class="cmb-td">
                    <ul class="cmb2-radio-list cmb2-list cmb2-radio-switch">
                        <li>
                            <input type="radio" class="cmb2-option cmb2-radio-switch1" name="wcpscu[quick_view]" id="wcpscu_quick_view1"
                                value="yes"
                        ...
                        <li>
                            <input type="radio" class="cmb2-option cmb2-radio-switch2" name="wcpscu[quick_view]" id="wcpscu_quick_view2"
            ...
            <div class="cmb-row cmb-type-radio">
                ...
                <div class="cmb-td">
                    <ul class="cmb2-radio-list cmb2-list cmb2-radio-switch">
                        <li><input type="radio" class="cmb2-option cmb2-radio-switch1" name="wcpscu[img_crop]" id="wcpscu_img_crop1"
                        ...
                        <li><input type="radio" class="cmb2-option cmb2-radio-switch2" name="wcpscu[img_crop]" id="wcpscu_img_crop2"
                                value="no" <?php if( !empty($img_crop)) { checked( 'no', $img_crop); } ?>> <label
                                for="wcpscu_img_crop2"><?php esc_html_e('No', WCPCSU_TEXTDOMAIN); ?></label></li>
                    </ul>
                    <p class="cmb2-metabox-description">
                        <?php esc_html_e('If the product images are not in the same size, this feature is helpful. It automatically resizes and crops. Note: your image must be higher than/equal to the cropping size set below. Otherwise, you may need to enable image upscaling feature from the settings below.', WCPCSU_TEXTDOMAIN); ?>
                    </p>
                </div>
            </div>
            ...
            <div class="cmb-row cmb-type-text-medium">
                ...
                <div class="cmb-td">
                    <input type="text" class="cmb2-text-small" name="wcpscu[crop_image_width]"
                        ...
                        value="<?php echo !empty($crop_image_width) ? intval($crop_image_width) : 300; ?>">
                    <p class="cmb2-metabox-description"><?php esc_html_e('Image cropping width', WCPCSU_TEXTDOMAIN); ?>
                    </p>
                </div>
            </div>
            ...
            <div class="cmb-row cmb-type-text-medium">
                <div class="cmb-th">
                    <label
                        for="wcpscu_crop_image_height"><?php esc_html_e('Image Height', WCPCSU_TEXTDOMAIN); ?></label>
                </div>
                <div class="cmb-td">
                    ...
                    <p class="cmb2-metabox-description"><?php esc_html_e('Image cropping height', WCPCSU_TEXTDOMAIN); ?>
                    </p>
                </div>
            </div>
        </div>
