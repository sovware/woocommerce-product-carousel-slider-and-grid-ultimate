    ...
    <div class="wpcu-dashboard-notice">
        ...
        <?php
            echo wp_kses_post( sprintf(
                ...
                __( 'We are giving away 25 premium licenses of WooCommerce Product Carousel, Slider and Grid Ultimate to our users for FREE. Claim before it’s gone! To claim <a href="%s" target="_blank">Click here.</a>', 'woocommerce-product-carousel-slider-and-grid-ultimate' ),
