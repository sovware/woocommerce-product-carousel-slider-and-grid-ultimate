...
if (!function_exists('wcpcsu_pagination')) {
    ...
    function wcpcsu_pagination($custom_post_query, $paged = 1)
    {
        ...
        $links = paginate_links(array(
            ...
            'prev_text' => apply_filters('wcpcsu_pagination_prev_text', '<span class="fa fa-chevron-left"></span>'),
            'next_text' => apply_filters('wcpcsu_pagination_next_text', '<span class="fa fa-chevron-right"></span>'),
        ));
        if ($links) {
